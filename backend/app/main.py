...
async def export_docx(data: dict):
    ...
    return JSONResponse(status_code=501, content={"detail": "DOCX export not implemented yet."})


@api_router.post("/export-html")
async def export_html(data: dict):
    # Placeholder for future implementation
    return JSONResponse(status_code=501, content={"detail": "HTML export not implemented yet."})
